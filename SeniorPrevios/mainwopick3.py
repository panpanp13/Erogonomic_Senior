...
def update(event):
    ...
    global state_check, state_history, state_change_count, set_state, state_count, sort_state, two_consider_state , previous_state, state, filtered_state_history
                ...
                if vector0 is None or head_theta0 is None or back_theta0 is None:
                    ...
                    try:
                        ...
                        if elapsed_time < 30 :
                            ...
                            # print(f"Sort State: {sort_state}")
                            # two_consider_state = [sort_state[i][0] for i in range(min(2, len(sort_state)))]
                            # print(f"2 Consider: {two_consider_state}")
                            # state_change_count = 0
                            # previous_state = None
                            # filtered_state_history = [state for state in state_history if state in two_consider_state]
                            # print("Filter state",filtered_state_history)
                            # for state in filtered_state_history:
                            ...
                            #     print("COUNTING", state_change_count)
                            #     kpn = 'extra'
                            #     stable = 'Muscle use'
                            #     print("EXTRA")  
